...
values
  ...
  (
    'submissions',
    '[{"id":"1","name":"김철수","studentId":"20223045","submittedAt":"01.21 14:32","autoScore":"85/100","testsPassed":"테스트 17/20 통과","aiAnalysis":"정상","aiAnalysisVariant":"green","finalScore":"85","status":"complete"},{"id":"2","name":"이영희","studentId":"20223067","submittedAt":"01.21 15:45","autoScore":"72/100","testsPassed":"테스트 14/20 통과","aiAnalysis":"검토 필요","aiAnalysisVariant":"yellow","aiSubNote":"표절 의심","finalScore":"72","status":"reviewing"},{"id":"3","name":"박민수","studentId":"20223089","submittedAt":"01.22 09:12","autoScore":"100/100","testsPassed":"테스트 20/20 통과","aiAnalysis":"우수","aiAnalysisVariant":"green","finalScore":"100","status":"complete"},{"id":"4","name":"최지원","studentId":"20223102","submittedAt":"-","autoScore":"-","testsPassed":"-","aiAnalysis":"-","aiAnalysisVariant":"red","finalScore":"0","status":"unsubmitted"}]'::jsonb
  ),
  (
    'conversations',
  ...
  (
    'admin_logs',
    '[{"id":1,"timestamp":"2026-03-04 15:28:42","type":"error","user":"시스템","message":"Docker 채점 컨테이너 타임아웃 (과제 ID: 204)"},{"id":2,"timestamp":"2026-03-04 15:26:18","type":"access","user":"김철수","message":"로그인 성공 — 192.168.1.42"},{"id":3,"timestamp":"2026-03-04 15:24:55","type":"ai","user":"이영희","message":"AI 튜터 질문 — 피보나치 수열 힌트 요청"},{"id":4,"timestamp":"2026-03-04 15:22:30","type":"grading","user":"박민수","message":"알고리즘 기초 실습3 자동 채점 완료 — 85점"},{"id":5,"timestamp":"2026-03-04 15:18:11","type":"error","user":"시스템","message":"Claude API 응답 지연 (3,200ms) — 재시도 성공"},{"id":6,"timestamp":"2026-03-04 15:15:04","type":"access","user":"이현기","message":"교수 로그인 — 강좌 관리 페이지 접근"},{"id":7,"timestamp":"2026-03-04 15:10:47","type":"grading","user":"최지훈","message":"웹 프로그래밍 과제1 자동 채점 완료 — 92점"},{"id":8,"timestamp":"2026-03-04 15:05:33","type":"error","user":"시스템","message":"DB 쿼리 응답 지연 (2,800ms) — 슬로우 쿼리 감지"}]'::jsonb
  ),
  (
