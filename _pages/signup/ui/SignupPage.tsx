    ...
    <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <div className="space-y-3">
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white py-3 font-medium text-gray-700 transition-colors hover:bg-gray-100"
        >
      ...
      <button
        type="button"
        onClick={() => router.push('/auth/role')}
        className="mt-6 w-full rounded-lg bg-gray-900 py-3 font-medium !text-white transition-colors hover:bg-gray-800 active:bg-black"
      >
        회원가입
      </button>
    </div>
